...
@section('content')
        ...
        <div class="row">
            <form action=""  class="form-parsley" method="post" enctype="multipart/form-data">
                @csrf
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">                                            
                            <textarea type="text" cols="5" rows="5" class="form-control" value="{{old('address')}}"  name="address" required></textarea>
                        </div>
