            ...
            <td>
                ...
                <div class="mo-openid-sort-apps ui-sortable" id="sortable">
                    ...
                    foreach ($selected_applications as $apps)
                    {
                        ...
                        ?>
                        <div class="mo-openid-sort-apps-div mo-openid-hover-div-sett" data-provider="<?php echo esc_attr($apps) ?>" id="<?php echo esc_attr($apps); ?>" style="opacity: <?php if(get_option('mo_openid_'.$apps.'_enable')) echo '1'; else echo '0.6'?>">
                            <div class="mo-openid-sort-apps-i-div mo-openid-sort-apps-open-settings-div" title="Configure Settings" style="cursor: pointer; background-color:<?php echo esc_attr($blcolor)?>;">
                                <div style="position: absolute;right: 5px;top: 5px;<?php if($checked!='checked') { ?> display: none; <?php } ?>" id="mo_openid_<?php echo esc_attr($apps); ?>_active_div">
                    ...
                    foreach ($selected_applications_premium as $apps)
                    {
                        ...
                        <div class="mo-openid-sort-apps-div mo-openid-hover-div-sett">
                            ...
                            <div id="mo-openid-hover-app-sett-show" style="display: block">
                                <div style="display: inline-block; text-align: center;width: 100%;position: absolute;font-size: 13px;"><span style="color:black"><?php if($apps == 'mailru') $apps='mail.ru'; if($apps == 'wiebo') $apps='weibo'; echo esc_attr(strtoupper($apps)); ?></span></div>
                            </div>
                        </div>
                        <?php
                    }
