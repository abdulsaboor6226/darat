...
<div class="wrap elementinvader_wrap bg-white">
    ...
    <div class="menu-top">
        <a class="logo" href="https://elementinvader.com" target="_blank"><img src="<?php echo ELEMENTINVADER_URL; ?>admin/images/elementinvader-logo.png" /></a>
        <nav class="">
        ...
        <div class="btn-group">
            ...
            <div class="input-group second-row">
                ...
                <div class="sort-element">
                 ...
                 <div class="toggle-pr">
                     <span><i class="fa fa-heart"></i> My Favorite</span>
                     <label class="switch">
                 ...
                 <div class="toggle-pr">
                     <span><i class="fa fa-thumbs-up"></i>My Likes</span>
                     <label class="switch">
                 ...
                 <div class="toggle-pr">
                     <span><i class="fa fa-user"></i>My Pages</span>
                     <label class="switch">
...
jQuery(document).ready(function($) {
    ...
    {
        var data_form = $('#search_form').serialize()+'&api_token=<?php echo get_option('elementinvader_api_token', ''); ?>';
        var that = $(this);
        ...
        var jqxhr = $.post( "<?php echo ELEMENTINVADER_WEBSITE; ?>marketplace/find", data_form, function(data) {
            ...
            jQuery('#panel_title').html(data.results.length+' Design Templates found');
