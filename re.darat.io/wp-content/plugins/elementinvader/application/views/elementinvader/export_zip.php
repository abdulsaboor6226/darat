        ...
        <div class="panel-body">
            ...
            <form method="post" action="<?php echo wmvc_current_edit_url(); ?>" class="form-layout" enctype="multipart/form-data" novalidate="novalidate">
                ...
                <div class="form-group">
                    ...
                    <i class="hint"><?php echo __('Make nice screenshot image with width 640px','elementinvader'); ?></i>
                </div>
                <div class="form-group">
                    ...
                    <i class="hint"><?php echo __('Make nice screenshot image with width 1280px','elementinvader'); ?></i>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="inline-checkbox">
                        <input <?php if(isset($_POST['required_plugins']) && array_search($plugin_slug, $_POST['required_plugins']) !== FALSE ):?> checked="checked" <?php endif;?> name="required_plugins[]" type="checkbox" class="form-control" value="<?php echo esc_attr($plugin_slug);?>"><?php echo esc_html($plugin_data['Name']); ?>
                    </label>
                    <?php endforeach;?>
                </div>
