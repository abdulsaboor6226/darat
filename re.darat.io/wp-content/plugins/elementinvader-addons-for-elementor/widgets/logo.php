...
class EliLogo extends Elementinvader_Base {
    ...
    $this->add_control(
        ...
        [
            ...
            'raw' => sprintf(__( 'Change WP default Site Title <a href="%1$s" target="_blank"> open </a>', 'elementinvader-addons-for-elementor' ), admin_url('options-general.php#blogname')),
    ...
    $this->add_control(
        ...
        [
            'label' => '',
            'type' => \Elementor\Controls_Manager::RAW_HTML,
            'raw' => sprintf(__( 'Change WP default Logos <a href="%1$s" target="_blank"> open </a>', 'elementinvader-addons-for-elementor' ), admin_url('customize.php'))
    ...
    $this->add_control(
        'custom_logo_image',
        [
            'label' => esc_html__( 'Custom Logo Image', 'plugin-name' ),
    ...
    $this->end_controls_section();
        ...
        $this->generate_renders_tabs($selectors, 'logo_section_img_dynamic',['margin','align','background','border','border_radius','padding','shadow','transition','image_size_control']);
