...
class EliMenu extends Elementinvader_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'mobile' => sprintf(__('Mobile (< %dpx)', 'elementinvader-addons-for-elementor'), $breakpoints['md']),
                        /* translators: %d: Breakpoint number. */
                        'tablet' => sprintf(__('Tablet (< %dpx)', 'elementinvader-addons-for-elementor'), $breakpoints['lg']),
                        'none' => esc_html__('None', 'elementinvader-addons-for-elementor'),
                    ],
        ...
        $this->add_responsive_control(
            'mobile_container',
            [
                    'label' => esc_html__( 'Padding Mobile Menu Container', 'wpdirectorykit' ),
        ...
        $this->add_responsive_control(
            'drop_box_padding',
            [
                    'label' => esc_html__( 'Drop List Padding', 'wpdirectorykit' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                    'label' => esc_html__( 'Sub menu Padding', 'wpdirectorykit' ),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
