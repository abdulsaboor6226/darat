...
class EliNewsletter extends Elementinvader_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                ...
                [
                    'label' => esc_html__('List id', 'elementinvader-addons-for-elementor'),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'description' => esc_html__('<a href="https://mailchimp.com/">Get Keys</a>', 'elementinvader-addons-for-elementor'),
                ]    
        );
