    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'Y',
                'description' => '<span class="eli_control_get_pro">'.sprintf(esc_html__(' %1$sExample Date Format%2$s','wpdirectorykit'),'<a href="https://www.php.net/manual/en/datetime.format.php" target="_blank">','</a>').'</span>'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'description' => '<span class="eli_control_get_pro">'.sprintf(esc_html__(' %1$sGet Examples%2$s','wpdirectorykit'),'<a href="https://www.php.net/manual/ru/function.strtotime.php" target="_blank">','</a>').'
                                 <br><br><b>'.esc_html__('Examples','wpdirectorykit').': </b>
                                 <br><b> +1 day </b> - '.esc_html__('Date +1 day','wpdirectorykit').'
                                 <br><b> +1 week </b> - '.esc_html__('Date +1 week','wpdirectorykit').'
                                 <br><b> +1 year </b> - '.esc_html__('Date +1 year','wpdirectorykit').'
                                 <br><b> +1 week 2 days 4 hours 2 seconds </b> - '.esc_html__('+1 week 2 days 4 hours 2 seconds','wpdirectorykit').'
                                 <br><b> last Monday </b> - '.esc_html__('last Monday','wpdirectorykit').'
                                 </span>'
            ]
        );
