        ...
        if(true){
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .eli_slider .eli_slider_ini.eli_s_image_cover .slick-list,
            ...
            $this->generate_renders_tabs($object, 't_styles_arrows_s', ['typo','color','background','border','border_radius','padding','shadow','transition']);
            ...
            $this->generate_renders_tabs($object, 't_styles_dots__s', 'full', ['align']);
