 ...
 * Elementor Pro tested up to: 3.6.7
 * 
 */
...
function elementinvader_addons_for_elementor_setup(){
    ...
    wp_enqueue_style( 'elementinvader_addons_for_elementor-widgets', plugins_url( '/assets/css/widgets.css', ELEMENTINVADER_ADDONS_FOR_ELEMENTOR__FILE__ ), false, false); 
