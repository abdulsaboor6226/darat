<div class="widget-eli eli_blog" id="eli_<?php echo esc_html($this->get_id_int());?>">
    <div class="eli_row <?php if($settings['masonry_enable'] == 'yes'):?> masonry <?php endif;?>">
        <?php
                ...
                <div class="eliblog-card-content">
                    ...
                    <div class="eliblog-card-meta-box">
                        <ul class="eli-post-meta">
                            <li><i class="fa fa-calendar"></i><?php echo get_the_date($date_format) ?></li>
                            <li><i class="fa fa-comment-o"></i><a href="<?php the_permalink(); ?>#comment-form" title="<?php echo esc_attr__('Comment', 'elementinvader-addons-for-elementor'); ?>"><?php comments_number(); ?></a></li>
                            <li>
                                <?php
                                    printf(
                            ...
                            if (has_tag()) {
                                ...
                                foreach ($eli_tags as $eli_tag) {
                                    ...
                                    echo '<li><i class="fa fa-bookmark-o"></i>';
