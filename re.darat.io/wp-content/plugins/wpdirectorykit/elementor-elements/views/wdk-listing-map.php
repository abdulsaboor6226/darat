...
?>
 <script>
    ...
    <?php if(is_numeric($lng)):?>
        ...
        $wdk_popup_content = '<div class="infobox map-box wdk-infobox-basic"><h3 class="title">'.esc_html(wdk_field_value('post_title', $wdk_listing_id)).'</h3>'
                              .'<p>'.esc_html(wdk_field_value('address', $wdk_listing_id)).'</p></div>';
