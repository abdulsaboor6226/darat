    ...
    <script>
        jQuery(document).ready(function($){
            $('#wdk_el_<?php echo esc_html($id_element);?> .wdk_results_listings_slider_ini').slick({
                dots: true,
                arrows: true,
                slidesToShow: <?php echo wmvc_show_data('layout_carousel_columns', $settings, 3);?>,
                slidesToScroll: <?php echo wmvc_show_data('layout_carousel_columns', $settings, 3);?>,
                ...
                responsive: [
                    {
                        breakpoint: 991,
                        settings: {
                            slidesToShow: <?php echo wmvc_show_data('layout_carousel_columns_tablet', $settings, '2');?>,
                            slidesToScroll:  <?php echo wmvc_show_data('layout_carousel_columns_tablet', $settings, '2');?>,
                        }
                    },
                    {
                        breakpoint: 768,
                        settings: {
                            slidesToShow: <?php echo wmvc_show_data('layout_carousel_columns_mobile', $settings, '1');?>,
                            slidesToScroll: <?php echo wmvc_show_data('layout_carousel_columns_mobile', $settings, '1');?>,
                        }
                    },
                ]
            });
