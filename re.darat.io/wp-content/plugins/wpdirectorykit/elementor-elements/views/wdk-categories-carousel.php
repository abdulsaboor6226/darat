            ...
            <div class="wdk-categories-carousel_ini <?php echo esc_html($settings['t_styles_img_des_type']);?> ">
                <?php foreach ($results as $key => $item):?>
                    <div class="wdk-slider-item">
                        <img src="<?php echo esc_url(wdk_image_src($item, 'full', NULL,'image_id'));?>" class="wdk-slider-item_thumbnail" alt="<?php echo esc_html(wmvc_show_data('category_title', $item));?>">
