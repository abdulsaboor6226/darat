...
<div class="wdk-element wdk-element-listing-agent" id="wdk_el_<?php echo esc_html($id_element);?>">
    <div class="wdk-row">
                    ...
                    if(!empty(wmvc_show_data('meta_fields_list', $settings)))
                        foreach (wmvc_show_data('meta_fields_list', $settings) as $meta):?>
                            ...
                            <?php if(filter_var($value, FILTER_VALIDATE_EMAIL) !== FALSE):?>
                                <div class="meta-item"><a href="mailto:<?php echo esc_attr($value);?>"><i class="far fa-envelope"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'youtube') !== FALSE):?>
                                <div class="meta-item"><a href="<?php echo esc_url($value);?>"><i class="fa fa-youtube"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'facebook') !== FALSE):?>
                                <div class="meta-item"><a href="<?php echo esc_url($value);?>"><i class="fa fa-facebook"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'linkedin') !== FALSE):?>
                                <div class="meta-item"><a href="<?php echo esc_url($value);?>"><i class="fa fa-linkedin"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'twitter') !== FALSE):?>
                                <div class="meta-item"><a href="<?php echo esc_url($value);?>"><i class="fa fa-twitter"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'telegram') !== FALSE):?>
                                <div class="meta-item"><a href="<?php echo esc_url($value);?>"><i class="fa fa-telegram"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'whatsapp') !== FALSE):?>
                                <div class="meta-item"><a href="//wa.me/<?php echo esc_attr(wdk_filter_phone($value));?>"><i class="fa fa-whatsapp"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'viber') !== FALSE):?>
                                <div class="meta-item"><a href="viber://chat?number=<?php echo esc_attr(wdk_filter_phone($value));?>"><i class="fab fa-viber"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(filter_var($value, FILTER_VALIDATE_URL) !== FALSE):?>
                                <div class="meta-item"><a href="<?php echo esc_url($value);?>"><i class="fa fa-anchor"></i><?php echo esc_html($value);?></a></div>
                            <?php elseif(strpos($meta['meta_field'],'phone') !== FALSE || wdk_is_phone($value)):?>
                                <div class="meta-item"><a href="tel:<?php echo esc_attr(wdk_filter_phone($value));?>"><i class="far fa-phone"></i><?php echo esc_html($value);?></a></div>
                            <?php else:?>
                                <div class="meta-item"><?php echo esc_html($value);?></div>
                            <?php endif;?>
                    <?php endforeach;?>
                </div>
            </div>
        ...
        <?php endif;?>
        <?php if(!empty($listing_alt_agents))foreach ($listing_alt_agents as $key => $agent):?>
            <?php
            $profile_url = '';
