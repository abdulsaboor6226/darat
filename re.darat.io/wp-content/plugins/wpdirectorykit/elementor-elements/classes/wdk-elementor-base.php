...
class WdkElementorBase extends Widget_Base {
	...
	protected function render() {
        ...
        public function generate_renders_tabs($selectors = array(), $tab_prefix='', $enable_options = array(), $disable_options = array()) {
            /* margin */
            //$options = ['margin','align','typo','color','background','border','border_radius','padding','shadow','transition','image_size_control', 'height', 'width','font-size','css_filters','background_group','hover_animation'];
