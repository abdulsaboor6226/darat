    ...
    private function generate_controls_styles() {
            ...
            $this->add_responsive_control(
                ...
                [
                        ...
                        'default' => '',
                        'selectors' => [
                            '{{WRAPPER}} .wdk_results_listings_slider_box .wdk-categories-carousel_arrows' => 'display: {{VALUE}};',
                        ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .wdk_results_listings_slider_box .wdk-categories-carousel_arrows' => '{{VALUE}};',
                    ],
                    'conditions' => [
                        'relation' => 'or',
                        'terms' => [
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk_results_listings_slider_box .wdk-categories-carousel_arrows .wdk_lr_slider_arrow.wdk_prev',
            );
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk_results_listings_slider_box .wdk-categories-carousel_arrows .wdk_lr_slider_arrow.wdk_next',
            );
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk_results_listings_slider_box .wdk-categories-carousel_arrows .wdk_lr_slider_arrow',
                'hover'=>'{{WRAPPER}} .wdk_results_listings_slider_box .wdk-categories-carousel_arrows .wdk_lr_slider_arrow%1$s'
            );
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk_results_listings_slider_box .slick-dots li .wdk_dot',
                'hover'=>'{{WRAPPER}} .wdk_results_listings_slider_box .slick-dots li .wdk_dot%1$s'
            );
