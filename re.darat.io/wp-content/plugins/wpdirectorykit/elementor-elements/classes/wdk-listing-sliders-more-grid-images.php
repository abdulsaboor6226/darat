 ...
 * @since 1.1.0
 */ 
class WdkListingSlidersGridMoreImages extends WdkElementorBase {
    ...
    public function get_name() {
        return 'wdk-listing-sliders-more-grid-images';
    }
    ...
    public function get_title() {
        return esc_html__('Wdk Listing Slider More Grid', 'wdk-listing-sliders');
    }
    ...
    protected function render() {
        ...
        $this->data['images_available'] = $this->data['images'];

        $this->data['images_left'] = array();
        $this->data['images_main'] = array();
        $this->data['images_right'] = array();

        if(!empty($this->data['images_available'])) {
            $this->data['images_main'] = array_slice($this->data['images_available'], 0, 1, true);
            $this->data['images_available'] = array_slice($this->data['images_available'], 1, null, true);
        }

        if(count($this->data['images_available']) >= 12) {
            $this->data['images_left'] = array_slice($this->data['images_available'], 0, 4, true);

            $this->data['images_available'] = array_slice($this->data['images_available'], 4,null, true);
        }elseif(count($this->data['images_available']) > 4) {
            $this->data['images_left'] = array_slice($this->data['images_available'], 0, 2, true);
            $this->data['images_available'] = array_slice($this->data['images_available'], 2,null, true);
        }

        if(count($this->data['images_available']) > 0) {
            $this->data['images_right'] = $this->data['images_available'];
        }
    ...
    private function generate_controls_conf() {
        ...
        $this->add_responsive_control(
            ...
            [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .wdk-listing-sliders-more-grid-images' => '{{UNIT}}',
                    ],
                    'default' => '100%', 
                    'separator' => 'before',
            ]
        ...
        $this->add_responsive_control (
            'styles_thmbn_nav_des_height_all',
            [
                ...
                'size_units' => [ 'px', 'vw', 'vh' ],
                'selectors' => [
                    '{{WRAPPER}} .wdk-cls-banner-thumbs' => 'height: {{SIZE}}{{UNIT}}',
                ],
                'separator' => 'after',
            ]
        );
        ...
        $this->add_control(
            'gallery_enable',
            [
                'label' => __( 'Gallery Enable (instead slider)', 'wdk-listing-sliders' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __( 'On', 'wdk-listing-sliders' ),
                'label_off' => __( 'Off', 'wdk-listing-sliders' ),
                'return_value' => 'yes',
    ...
    private function generate_controls_styles() {
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Thumbnail', 'wdk-listing-sliders'),
                    'tab' => '1',
                ]
            );
            $this->add_responsive_control (
                ...
                [
                    ...
                    'size_units' => [ 'px'],
                    'selectors' => [
                        '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-cls-banner-thumbs .banner-thumbs .banner-grid' => 'padding: {{SIZE}}{{UNIT}}',
                        '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-cls-banner-thumbs .banner-thumbs' => ' height: calc(100% +  {{SIZE}}{{UNIT}} * 1);',
                    ],
                ]
            );

            $this->add_control(
                '_styles_thmbn_des_height_hr',
                [
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-cls-banner-thumbs .banner-thumbs .banner-thumb .banner-thumb-link',
                'hover' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-cls-banner-thumbs .banner-thumbs .banner-thumb .banner-thumb-link%1$s',
                'active' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-cls-banner-thumbs .banner-thumbs .banner-thumb.wdk-active-nav .banner-thumb-link',
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__('Container', 'wdk-listing-sliders'),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-cls-banner-thumbs',
            );
            ...
            $this->add_responsive_control(
                ...
                [
                        ...
                        'default' => '',
                        'selectors' => [
                            '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-listing-sliders-more-grid-images_arrows' => 'display: {{VALUE}};',
                        ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => \Elementor\Controls_Manager::SELECT,
                    'default' => 'wdk-listing-sliders-more-grid-images_arrows_middle',
                    'options' => [
                        ''  => __( 'Default', 'wdk-listing-sliders' ),
                        'wdk-listing-sliders-more-grid-images_arrows_bottom'  => __( 'Bottom', 'wdk-listing-sliders' ),
                        'wdk-listing-sliders-more-grid-images_arrows_middle' => __( 'Center', 'wdk-listing-sliders' ),
                        'wdk-listing-sliders-more-grid-images_arrows_top' => __( 'Top', 'wdk-listing-sliders' ),
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-listing-sliders-more-grid-images_arrows' => '{{VALUE}};',
                    ],
                    'conditions' => [
                        'terms' => [
                            [
                                ...
                                'operator' => '!=',
                                'value' => 'wdk-listing-sliders-more-grid-images_arrows_middle',
                            ]
                        ],
                    ],
                ]
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-listing-sliders-more-grid-images_arrows .wdk-listing-sliders-more-grid-images_arrow.wdk-slider-prev',
            );
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-listing-sliders-more-grid-images_arrows .wdk-listing-sliders-more-grid-images_arrow.wdk-slider-next',
            );
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-listing-sliders-more-grid-images_arrows .wdk-listing-sliders-more-grid-images_arrow',
                'hover'=>'{{WRAPPER}} .wdk-listing-sliders-more-grid-images .wdk-listing-sliders-more-grid-images_arrows .wdk-listing-sliders-more-grid-images_arrow%1$s'
            );
            ...
            $this->add_responsive_control(
                    ...
                    [
                            ...
                            'default' => 'none',
                            'selectors' => [
                                '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots' => 'display: {{VALUE}} !important;',
                            ],
                    ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots' => '{{UNIT}}',
                        ],
                        'default' => '100%', 
                        'separator' => 'before',
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots' => '{{VALUE}};',
                    ],
                ]
            );
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots li .wdk_dot',
                'hover'=>'{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots li .wdk_dot%1$s',
                'active'=>'{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots li.slick-active .wdk_dot'
            ); 
            ...
            $selectors = array(
                'hover'=>'{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots li .wdk_dot%1$s i, {{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots li .wdk_dot%1$s svg',
            ); 
            ...
            $selectors = array(
                'normal' => '{{WRAPPER}} .wdk-listing-sliders-more-grid-images .slick-dots',
            ); 
    ...
    public function enqueue_styles_scripts() {
        wp_enqueue_style('wdk-listing-sliders-more-grid-images');
