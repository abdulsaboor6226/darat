            ...
            <?php foreach ( $locations as $location ):?>
                <tr>
                    ...
                    <td class="actions_column">
                        <a href="<?php echo get_admin_url() . "admin.php?page=wdk_location&function=edit&id=".wmvc_show_data('idlocation', $location, '-'); ?>"><span class="dashicons dashicons-edit"></span></a>
                        <a class="question_sure" href="<?php echo get_admin_url() . "admin.php?page=wdk_location&function=delete&id=".wmvc_show_data('idlocation', $location, '-'); ?>"><span class="dashicons dashicons-no"></span></a>
                    </td>
                </tr>
            <?php endforeach; ?>
