<?php
/**
 * The template for Edit field LISTING READONLY.
 *
        ...
        <span class="regular-span">
            <?php 
                if(wmvc_show_data($field_id, $db_data, false)) {
                    ?>
                        <a target="_blank" href="<?php echo esc_url(get_permalink(wdk_field_value ('ID', wmvc_show_data($field_id, $db_data))));?>"><?php echo esc_html(wdk_field_value ('post_title', wmvc_show_data($field_id, $db_data))); ?></a>
                    <?php
                } else {
                    ?>
