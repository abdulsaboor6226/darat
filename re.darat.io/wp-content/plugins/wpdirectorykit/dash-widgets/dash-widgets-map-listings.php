...
class WDK_Dashboard_Widget_Map_Listings extends WDK_DashWidgets {
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            array('WDK_Dashboard_Widget_Map_Listings','widget'),      //Callback for the main widget content
            array('WDK_Dashboard_Widget_Map_Listings','config')       //Optional callback for widget configuration content
        );
    }
