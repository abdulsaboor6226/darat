...
class WDK_DashWidgets {
    ...
    */
	private function add_widgets() {
		...
		add_action('wp_dashboard_setup', array('WDK_Dashboard_Widget_News','init') );
		add_action('wp_dashboard_setup', array('WDK_Dashboard_Widget_Latest_Listings','init') );
		add_action('wp_dashboard_setup', array('WDK_Dashboard_Widget_Map_Listings','init') );
