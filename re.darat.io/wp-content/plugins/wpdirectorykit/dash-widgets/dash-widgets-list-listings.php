...
class WDK_Dashboard_Widget_Latest_Listings extends WDK_DashWidgets {
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            array('WDK_Dashboard_Widget_Latest_Listings','widget'),      //Callback for the main widget content
            array('WDK_Dashboard_Widget_Latest_Listings','config')       //Optional callback for widget configuration content
        );
    }
