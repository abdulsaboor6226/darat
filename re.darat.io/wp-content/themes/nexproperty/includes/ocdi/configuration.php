...
function ocdi_import_files() {
	$pac_name = 'demo-content_premium.pac';
  ...
  function ocdi_register_plugins( $plugins ) {
    ...
    if (file_exists(get_template_directory() .'/addons/wdk-payments.zip')) {
        $theme_plugins[] = [
              'name'     => 'WDK Payments',
              'slug'     => 'wdk-payments',  // The slug has to match the extracted folder from the zip.
              'source'   =>  get_template_directory() . '/addons/wdk-payments.zip',
              'required' => false,
              'preselected' => true,
        ];
        $theme_plugins[] = [
