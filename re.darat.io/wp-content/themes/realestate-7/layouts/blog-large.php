	...
	echo '<div class="post-thumb col span_12 first">';
		if(count($attachments) > 1 && $ct_auto_slider != 'No') {
			...
			echo '<a class="thumb" href="';
				the_permalink();
			echo '">';
				the_post_thumbnail(array(2000,800));  
			echo '</a>';
			echo '</figure>';
		}
	echo '</div>';
            ...
            <p class="marB0">
				<span class="meta">
                    ...
                    <?php if(!is_search()) { ?>
                        ...
                        ?>
                        <?php if ( isset( $cat->cat_ID ) && isset( $cat->cat_name ) ): ?>

							<?php esc_html_e('in', 'contempo'); ?>

                             <a href="<?php echo home_url(); ?>/?cat=<?php echo esc_html($cat->cat_ID); ?>">
                    ...
                    <?php  if($ct_post_comments == 'yes') {  esc_html_e('with', 'contempo'); ?>
