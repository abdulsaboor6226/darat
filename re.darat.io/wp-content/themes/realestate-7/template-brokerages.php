        ...
        <ul id="brokerage-list">
            ...
            ?>   
                ...
                <?php } ?>
                    ...
                    <!-- Brokerage -->
                    <li class="brokerage brokerage-wrap <?php echo esc_html($ct_brokerage_layout); ?> <?php if($ct_brokerage_layout == 'brokerage-grid') { echo 'col span_3'; } ?>">
                        <?php if(has_post_thumbnail()) {
                            $feat_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); ?>
                            <figure class="col <?php if($ct_brokerage_layout == 'brokerage-grid') { echo 'span_12'; } else { echo 'span_3'; } ?> first">
                                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                                    <img class="brokerage-img" src="<?php echo esc_html($feat_image); ?>" />
                                </a>
                            </figure>
                        <?php } ?>
