...
<?php } ?>
	...
	<!-- Container -->
	<div id="page-content" class="container <?php if($top_page_margin != 'No') { echo 'marT60'; } ?> <?php if($bottom_page_margin != 'No') { echo 'padB60'; } ?>">

		<!-- Page Content -->
		<?php if(!is_active_sidebar('right-sidebar-pages')) {
			echo '<div class="page-content col span_12 first">';
		} else {
			echo '<div class="page-content col span_9">';
		} ?>
			...
			<div class="inner-content">
				...
				wp_link_pages(
					array(
						'before' => '<div class="page-links">' . __( 'Pages:', 'contempo' ),
						'after'  => '</div>',
					)
				);
